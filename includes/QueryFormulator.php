<?php
/**
 * QUERY_FORMULATOR class
 * 
 * Interprets the requested Bible quote and translated it into an SQL query.
 * Will set the BIBLEGET_QUOTE instance's public variables $formulatedQueries and $formulatedVariants
 *   as well as $originalQueries
 * 
