...
CREATE TABLE IF NOT EXISTS requests_log (
    ...
    "HTTP_CLIENT_IP"       VARCHAR(46) NOT NULL DEFAULT '',
    "HTTP_X_FORWARDED_FOR" VARCHAR(1000) NOT NULL DEFAULT '',
    "HTTP_X_REAL_IP"       VARCHAR(46) NOT NULL DEFAULT '',
    "REMOTE_ADDR"          VARCHAR(46) NOT NULL DEFAULT '',
